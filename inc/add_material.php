...
$materialCat->m_cat_description = htmlspecialchars(trim("Keine Beschreibung vorhanden!"), ENT_QUOTES);

$materialCat->addMaterialCat($mysqli_link);
...
$material->addMaterial($mysqli_link);
